...
export default function Layout({ children }) {
    ...
    return (_jsxs("div", { className: "min-h-screen flex flex-col max-w-md mx-auto bg-white", children: [_jsx("main", { className: "flex-1 overflow-auto pb-20 px-4 pt-6", children: children }), showMore && (_jsxs("div", { className: "fixed bottom-16 left-1/2 -translate-x-1/2 w-full max-w-md bg-white border-t border-gray-100 px-4 py-3 space-y-1 z-10", children: [_jsxs("div", { className: "mb-3 rounded-2xl border border-gray-100 bg-gray-50 p-3", children: [_jsx("p", { className: "text-xs text-gray-400", children: "Active profile" }), _jsx("p", { className: "text-sm font-medium text-gray-900", children: user?.name || 'No profile' }), _jsxs("div", { className: "mt-2 flex items-center justify-between gap-2", children: [_jsxs("p", { className: "text-xs text-gray-400", children: [users.length, " saved profile", users.length === 1 ? '' : 's'] }), _jsx("button", { onClick: () => {
                                            setShowMore(false);
                                            navigate('/onboarding');
                                        }, className: "text-xs font-medium text-brand-500", children: "Manage users" })] })] }), moreNav.map((n) => (_jsxs(NavLink, { to: n.to, onClick: () => setShowMore(false), className: "flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-gray-50 transition-colors", children: [_jsx("span", { className: "text-xl w-8 text-center", children: n.icon }), _jsxs("div", { children: [_jsx("p", { className: "text-sm font-medium text-gray-900", children: n.label }), _jsx("p", { className: "text-xs text-gray-400", children: n.desc })] })] }, n.to)))] })), showMore && _jsx("div", { className: "fixed inset-0 z-0", onClick: () => setShowMore(false) }), _jsx("nav", { className: "fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-md bg-white border-t border-gray-100 z-20", children: _jsx("div", { className: "grid grid-cols-5", children: mainNav.map((n) => {
