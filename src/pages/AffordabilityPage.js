...
export default function AffordabilityPage() {
    ...
    const scoreBg = result
        ...
        : '';
    return (_jsxs("div", { className: "space-y-4", children: [_jsx("h1", { className: "text-xl font-semibold text-gray-900", children: "Can I afford it?" }), _jsxs(Card, { children: [_jsxs("h2", { className: "text-sm font-medium text-gray-700 mb-3", children: ["Your finances (", currency, "/month)"] }), _jsx("div", { className: "space-y-3", children: [
